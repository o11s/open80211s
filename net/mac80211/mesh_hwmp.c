...
/**
 * mesh_nexthop_lookup - fill in next hop and outgoing interface in skb.
 *
 * @skb: 802.11 frame to be sent
 * @mbss: MBSS in which to find a path
 *
 * Calling this function is considered "using" the associated mpath, so preempt
 * a path refresh if this mpath expires soon.
 *
